...
[Green Algeria Map's](https://github.com/samir1498/green-algeria-map) benchmark pipeline ran. The numbers looked reasonable. NestJS was 9x slower than Go on auth, Spring Boot was in between. Clean tables, tidy comparisons.
